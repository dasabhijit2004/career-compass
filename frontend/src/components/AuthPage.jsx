...
export default function AuthPage() {
  ...
  const handleAuth = async (values, { setSubmitting }) => {
    try {
      if (isLogin) {
        ...
        // 🔥 Add user document with isPremium = false
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Optional: create a document if not exists
      await setDoc(
      ...
      >
        ...
        <div className="w-full md:w-1/2 p-8">
              ...
              <Form className="space-y-4">
                <div>
                  <Field
                    ...
                    type="email"
                    placeholder="Email"
                    className="w-full p-2 border rounded focus:ring focus:ring-blue-500 focus:outline-none focus:border-blue-500"
                  />
                  <ErrorMessage
                    name="email"
                    component="div"
          ...
          <button
            ...
            className="w-full mt-2 bg-red-500 text-white p-2 rounded-xl hover:bg-red-600"
          >
            Login with Google
          </button>
